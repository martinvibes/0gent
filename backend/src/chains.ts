...
const chains: Record<string, ChainConfig> = {
  celo: {
    ...
    paymentContract: process.env.CELO_PAYMENT_CONTRACT || "0x45568d8939795c1Ec86656f571325011f3A67da8",
    registryContract: process.env.CELO_REGISTRY_CONTRACT || "0x0745e722819B86841dCB4E223204a9AfA815A394",
